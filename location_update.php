...
$get_info = mysqli_query($link,"SELECT country,city,hometown FROM users WHERE username='$user'");
...
if ($send) {
	...
	$hometown = mysqli_real_escape_string($link,$hometown);
	$hometown = ucwords($hometown);
		//submit the form to database
		$info_submit_query = mysqli_query($link,"UPDATE users SET city='$city' WHERE username='$user'");
		$info_submit_query = mysqli_query($link,"UPDATE users SET country='$country' WHERE username='$user'");
		$info_submit_query = mysqli_query($link,"UPDATE users SET hometown='$hometown' WHERE username='$user'");
