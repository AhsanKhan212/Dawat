...
<body>
	...
	$about_query = mysqli_query($link,"SELECT school,concentration,city,hometown,queote,bio,company,position,mobile,pub_email,relationship FROM users WHERE username='$username'");
