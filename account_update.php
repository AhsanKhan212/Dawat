...
$get_info = mysqli_query($link,"SELECT first_name,nick_name FROM users WHERE username='$user'");
...
if ($updateinfo) {
	...
	if(strlen($firstname) < 7 || strlen($firstname) > 20 )  {
		...
		$info_submit_query = mysqli_query($link,"UPDATE users SET first_name='$firstname' WHERE username='$user'");
